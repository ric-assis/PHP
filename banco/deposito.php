...
<html>
	...
	<body>		
		<div class="container mt-3"><h1 class="text-center">Banco Mundial - Depósito</h1><hr/></div>		
		<div class="container d-flex align-items-center justify-content-center">				
			<div class="row mb-3 d-flex flex-column align-items-center">
				<div class="col-md-12">												
					<form id="frmDepositar" method="POST">	
				...
				<div class="col-md-12 mb-3 mt-3">
					<button class="btn btn-primary mb-1 btn-block" onclick="$('#frmDepositar').submit()">Depósitar</button>								
				</div>					
				<div id="relatorio" class="col-md-12 justify-content-center mt-3">
